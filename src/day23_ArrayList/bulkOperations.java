...
public class bulkOperations {
    public static void main(String[] args) {
        ...
        scores.addAll(Arrays.asList(75,85,95,100,25));
       ...
       // l1.addAll( Arrays.asList(nums));
        ...
        boolean hasAlenaGadri = employeesList.containsAll(Arrays.asList("Alena", "Gadir"));
        boolean hasAlenagadriMuhtar = employeesList.containsAll(Arrays.asList("Kuzat", "Ali", "Muhtar"));

        System.out.println(hasAlena);
        System.out.println(hasAlenaGadri);
        System.out.println(hasAlenagadriMuhtar);
        System.out.println("???????????????????????????");
